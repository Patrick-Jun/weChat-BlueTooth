Component({
    ...
    methods : {
                ...
                this.data.timer = setTimeout(()=>{
                    ...
                    indexItems.forEach((item,index) => {
                        if( item.data.name && fixedData.indexOf( item.data.name ) === -1 ){
                            console.log(item.data.name>"Z"||item.data.name<"A")
                            if(item.data.name>"Z"||item.data.name<"A"){
                              data.push("*");
        ...
        handlerTouchMove(event){
            ...
            index = index >= data.itemLength ? data.itemLength -1 : index-1;
